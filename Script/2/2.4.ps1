...
if($row['value_configured'] -eq 0 -and $row['value_in_use'] -eq 0){
    Write-Output "No changes needed. 'Database Mail XPs' Server Configuration Option is set to 0"
}
else{
    ...
    if($sqlDataAdapter){
        Write-Output "Successfully configured 'Database Mail XPs' Server Configuration Option to 0."
